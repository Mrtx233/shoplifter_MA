...
base_url = 'https://www.mfa.gov.cn/web/wjdt_674879/zwbd_674895/'
url_name = '外交部'
notification_path = '驻外报道'
base_path = rf'E:\WorkingWord\马缕_新闻搞采集(7.29-8.2)\中央和国家机关、群团组织等政务发布平台\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[4]/div[2]/div[2]/div/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[4]/div[2]/div/div[1]/h1/text()'
menu_xpath = '/html/body/div[4]/div[1]//a//text()'
fb_time_xpath = '/html/body/div[4]/div[2]/div/div[1]/p/span/text()'
ly_name_xpath = '/html/body/div[4]/div[2]/div/div[1]/p/span/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//*[@id="News_Body_Txt_A"]//p'):

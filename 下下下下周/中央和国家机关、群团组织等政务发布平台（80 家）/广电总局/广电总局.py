...
base_url = 'https://www.nrta.gov.cn/col/col112/index.html?uid=15408&pageNum='
url_name = '广电总局'
notification_path = '总局要闻'
base_path = rf'E:\WorkingWord\马缕_新闻搞采集(7.29-8.2)\中央和国家机关、群团组织等政务发布平台\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="15408"]/div/li/div/a/@href'
tit_xpath = '//*[@id="artTitMob"]/text()'
menu_xpath = '//*[@id="barrierfree_container"]/div[2]/div/table/tbody/tr/td[2]/table/tbody/tr/td/table//a//text()'
fb_time_xpath = '//*[@id="c"]/tbody/tr[2]/td/table/tbody/tr/td[1]/text()'
ly_name_xpath = '//*[@id="c"]/tbody/tr[2]/td/table/tbody/tr/td[2]/text()'
...
for i in range(31, 51):
    ...
    for page in page_list:
        try:
            ...
            page_url = page
            # page_url = 'https://www.neac.gov.cn' + re.sub(r'\./', '/', page)
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//*[@id="c"]//p'):

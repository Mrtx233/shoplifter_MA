...
base_url = 'https://www.neac.gov.cn/seac/xwzx/mwyw/'
url_name = '国家民委'
notification_path = '民委要闻'
base_path = rf'E:\WorkingWord\马缕_新闻搞采集(7.29-8.2)\中央和国家机关、群团组织等政务发布平台\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[2]/div[2]/div/p[2]/text()'
menu_xpath = '/html/body/div[2]/div[1]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[2]/div/p[3]/span[1]/text()'
ly_name_xpath = '/html/body/div[2]/div[2]/div/p[3]/span[2]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('/html/body/div[2]/div[2]/div/div//p'):

...
url_name = '人民日报'
A_url = 'http://theory.people.com.cn'
base_urls = [
    'http://renshi.people.com.cn/',
    'http://fanfu.people.com.cn/',
    'http://theory.people.com.cn/GB/49150/',
    'http://theory.people.com.cn/GB/49154/',
    'http://theory.people.com.cn/GB/136457/'
]
...
page_list_xpath = '/html/body/div[6]/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[6]/div[1]/div/h1/text()'
menu_xpath = '//div[@class="fl"]//a//text()'
fb_time_xpath = '/html/body/div[6]/div[1]/div/p[2]/text()'
ly_name_xpath = '/html/body/div[6]/div[1]/div/p[2]/a/text()'
base_path = rf'E:\WorkingWord\马缕_新闻稿采集(7.22-7.26)\中央新闻单位\{url_name}'
            ...
            for page in page_list:
                try:
                    ...
                    with open(file_path, 'a+', encoding='utf-8') as file:
                        file.write(tit + '\n')
                        for p_text in page_tree.xpath('/html/body/div[6]/div[1]/div/div[2]//p'):

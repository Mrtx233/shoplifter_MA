...
url = 'https://www.cs.com.cn/bx/'
target_xpath = '/html/body/div[5]/div/div/div[1]/ul/li/a'
returned_final_links = extract_links(url, target_xpath)

url_name = '中国证券报'
notification_path = '保险Insurance'
base_path = f'E:\\WorkingWord\\马缕_新闻稿采集(7.22-7.26)\\中央新闻网站\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

tit_xpath = '/html/body/div[6]/div/div/div[1]/article/header/h1/text()'
...
menu_xpath = '//div[@class="artc_route"]//a//text()'
fb_time_xpath = '/html/body/div[5]/div/div/div[1]/article/header/div[2]/div[1]/time/text()'
ly_name_xpath = '/html/body/div[5]/div/div/div[1]/article/header/div[2]/div[1]/em[2]/text()'
...
for page in returned_final_links:
    try:
        ...
        with open(file_path, 'a+', encoding='utf-8') as file:
            file.write(tit + '\n')
            for p_text in page_tree.xpath('/html/body/div[6]/div/div/div[1]/article/section//p'):

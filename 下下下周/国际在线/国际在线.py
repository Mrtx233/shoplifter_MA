...
url = 'https://ge.cri.cn/roll'
target_xpath = '/html/body/div[3]/div/div[1]/div[2]/div[1]/div/ul/li/a'
returned_final_links = extract_links(url, target_xpath)

url_name = '国际在线'
notification_path = '环球创业-滚动'
base_path = f'E:\\WorkingWord\\马缕_新闻稿采集(7.22-7.26)\\中央新闻网站\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

tit_xpath = '/html/body/div[3]/div[1]/div[1]/p/text()'
menu_xpath = '//ul[@class="secondPage-crumbs"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div[1]/div[1]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[3]/div[1]/div[1]/div[1]/span[3]/a[2]/text()'

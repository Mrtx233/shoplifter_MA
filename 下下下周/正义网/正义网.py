...
url = 'https://news.jcrb.com/'
target_xpath = '/html/body/div[2]/div[1]/div[2]/ul/li/h2/a'
returned_final_links = extract_links(url, target_xpath)

url_name = '正义网'
notification_path = '新闻'
base_path = f'E:\\WorkingWord\\马缕_新闻稿采集(7.22-7.26)\\中央新闻网站\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

tit_xpath = '/html/body/div[3]/h1/text()'
menu_xpath = '//div[@class="curpage"]//a//text()'
fb_time_xpath = '//*[@id="pubtime_baidu"]/text()'
ly_name_xpath = '//*[@id="source_baidu"]/text()'
...
for page in returned_final_links:
    try:
        ...
        with open(file_path, 'a+', encoding='utf-8') as file:
            file.write(tit + '\n')
            for p_text in page_tree.xpath('//*[@id="fontzoom"]//p'):

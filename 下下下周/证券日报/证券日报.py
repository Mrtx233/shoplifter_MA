...
url_name = '证券日报'
A_url = 'https://topics.gmw.cn/'
base_urls = [
    'http://www.zqrb.cn/tmt/tmthangye',
    'http://www.zqrb.cn/tmt/xinpinsudi',
    'http://www.zqrb.cn/tmt/tmtgundong'
]
...
page_list_xpath = '/html/body/div[4]/div/div[1]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[4]/div/div[1]/div[2]/h1/text()'
menu_xpath = '//div[@class="l_weizhi"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[3]/div[1]/div[2]/div[1]/text()'
ly_name_xpath = '/html/body/div[2]/div[3]/div[1]/div[2]/div[1]/text()'
            ...
            for page in page_list:
                try:
                    ...
                    with open(file_path, 'a+', encoding='utf-8') as file:
                        file.write(tit + '\n')
                        for p_text in page_tree.xpath('/html/body/div[4]/div/div[1]/div[2]/div[3]//p'):

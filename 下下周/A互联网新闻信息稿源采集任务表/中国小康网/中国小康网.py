...
base_url = 'https://news.gmw.cn/node_23548.htm'
url_name = '中国小康网'
notification_path = '要闻'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[4]/div[1]/div[2]/ul/li/span[1]/a/@href'
...
for i in range(1, 2):
    if i == 1:
        ...
        url = f'https://news.gmw.cn/node_23548_{i}.html'

...
base_url = 'https://www.ccn.com.cn/news/jinrong.dhtml'
case_url = 'https://www.ccn.com.cn/news/jinrong.dhtml?page='
url_name = '中国消费网'
notification_path = '首页-金融'
base_path = f'E:\\WorkingWord\\马缕_新闻稿采集(7.22-7.26)\\中央新闻网站\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div/div[6]/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div/div[6]/div[1]/div[1]/div[1]/text()'
menu_xpath = '//div[@class="g_positionBox"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div/div[6]/div[1]/div[1]/div[2]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[3]/div/div[6]/div[1]/div[1]/div[2]/div[1]/span[3]/text()'
...
for i in range(45, 101):
    try:
        ...
        for page in page_list:
            try:
                # time.sleep(random.uniform(0.101, 1))
                # page_url = page
                page_url = 'https://www.ccn.com.cn' + re.sub(r'\./', '/', page)
                ...
                with open(file_path, 'a+', encoding='utf-8') as file:
                    file.write(tit + '\n')
                    for p_text in page_tree.xpath('/html/body/div[3]/div/div[6]/div[1]/div[1]/div[3]//p'):

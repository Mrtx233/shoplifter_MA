...
base_url = 'https://news.youth.cn/gn/'
url_name = '中国日报网'
notification_path = '通知公告123'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.119)\\司法局\\吉林省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div[1]/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[2]/div[2]/div/div[2]/p[1]/text()'
menu_xpath = '//span[@class="lm_mc"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[2]/div/div[2]/p[3]/text()'
ly_name_xpath = '/html/body/div[2]/div[2]/div/div[2]/p[3]/text()'
target_tag = 'div'
target_attr = {'class': 'TRS_Editor'}
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                file_name = sanitize_filename(file_name)  # 清理文件名中的非法字符
                ...
                output_doc_path = os.path.join(folder_path, f'{file_name}.docx')
                main(page_url, target_tag, target_attr, output_doc_path)
                file_size = os.stat(output_doc_path).st_size // 1024
                if file_size < 35:

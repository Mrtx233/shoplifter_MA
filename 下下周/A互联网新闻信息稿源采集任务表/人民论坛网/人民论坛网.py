...
url_name = '人民论坛网'
base_urls = [
    'http://www.rmlt.com.cn/thinktank/yw/',
    'http://www.rmlt.com.cn/thinktank/yjbg/',
    'http://www.rmlt.com.cn/thinktank/zjgd/',
    'http://www.rmlt.com.cn/thinktank/ztdy/',
    'http://www.rmlt.com.cn/thinktank/zhiku/',
    'http://www.rmlt.com.cn/thinktank/dfts/'
]
...
page_list_xpath = '/html/body/div/section/div/dl/dd/ul/li/a/@href'
tit_xpath = '/html/body/section/section/article/div[1]/h1/text()'
menu_xpath = '//div[@class="crumb column mar-t-10"]//a//text()'
fb_time_xpath = '/html/body/section/section/article/div[1]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/section/section/article/div[1]/div[1]/span[2]/text()'
            ...
            for page in page_list:
                try:
                    ...
                    with open(file_path, 'a+', encoding='utf-8') as file:
                        file.write(tit + '\n')
                        for p_text in page_tree.xpath('/html/body/section/section/article/div[1]/div[2]//p'):
                            # /html/body/section/section/article/div[1]/div[3]
                            # /html/body/section/section/article/div[1]/div[2]

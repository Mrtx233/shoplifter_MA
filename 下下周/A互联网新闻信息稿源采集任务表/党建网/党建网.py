...
base_url = 'http://www.dangjian.com/shouye/dangjiangongzuo/wenmingshijianzhongxin/'
url_name = '党建网'
notification_path = '新时代文明实践中心'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[6]/div/div[3]/ul/li/div[1]/a/@href'
tit_xpath = '//*[@id="title_tex"]/text()'
menu_xpath = '//div[@class="main-tit"]//a//text()'
fb_time_xpath = '//*[@id="time_tex"]/text()'
ly_name_xpath = '//*[@id="time_ly"]/text()'

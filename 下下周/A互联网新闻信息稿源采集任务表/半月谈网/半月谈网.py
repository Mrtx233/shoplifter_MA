...
base_url = 'http://www.banyuetan.org/byt/xuexizhan/'
url_name = '半月谈网'
notification_path = '学习站'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div[1]/div/div[2]/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div[1]/div[1]/div[1]/h1/text()'
menu_xpath = '//div[@class="crumb-nav"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div[1]/div[1]/div[1]/div/div[1]/text()'
ly_name_xpath = '/html/body/div[3]/div[1]/div[1]/div[1]/div/div[2]/text()'
target_tag = 'div'
target_attr = {'class': 'detail_content'}

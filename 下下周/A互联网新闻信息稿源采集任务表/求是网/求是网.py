...
base_url = 'http://www.qstheory.cn/v9zhuanqu/zhuanqu/ymrw/index.htm'
url_name = '求是网'
notification_path = '英模人物'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[1]/div[4]/div/div[2]/div/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div/div/div/div/h1/text()'
menu_xpath = '//div[@class="main-tit"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div/div/div/div/span[3]/text()'
ly_name_xpath = '/html/body/div[3]/div/div/div/div/span[1]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@class="highlight"]//p'):

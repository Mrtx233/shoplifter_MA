...
url_name = '环球人物网'
notification_path = '视野'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[4]/div/div[3]/div[1]/div/a/@href'
tit_xpath = '/html/body/div[4]/div/div[2]/div[1]/div[1]/div[1]/span/h1/text()'
menu_xpath = '//div[@class="sl_tit"]//a//text()'
fb_time_xpath = '/html/body/div[4]/div/div[2]/div[1]/div[1]/div[2]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[4]/div/div[2]/div[1]/div[1]/div[2]/div[1]/span[2]/text()'
target_tag = 'div'
target_attr = {'class': 'sl_lLlx3'}
...
for i in range(11,31):
    url = f'https://www.globalpeople.com.cn/index.php?m=content&c=index&a=lists&catid=91&page={i}'

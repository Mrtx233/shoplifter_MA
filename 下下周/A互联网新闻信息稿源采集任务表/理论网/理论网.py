...
base_url = 'https://www.cntheory.com/wscy/'
url_name = '理论网'
notification_path = '文史参阅'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="liebiao"]/li/a/@href'
tit_xpath = '/html/body/table[1]/tbody/tr/td/table[2]/tbody/tr/td/div[1]/text()'
menu_xpath = '//td[@class="icon15 gray font_16"]//a//text()'
fb_time_xpath = '/html/body/table[1]/tbody/tr/td/table[2]/tbody/tr/td/table/tbody/tr/td[1]/text()'
ly_name_xpath = '/html/body/table[1]/tbody/tr/td/table[2]/tbody/tr/td/table/tbody/tr/td[1]/text()'
...
for i in range(0, 6):
    ...
    for page in page_list:
        try:
            ...
            # print(tit,menu,fb_time,ly_name)
            file_path = f'{folder_path}\\{tit}.docx'

            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@class="TRS_Editor"]//p'):
                    if p_text.xpath('.//text()') != '':
                        content = ''.join(p_text.xpath('.//text()'))
                        file.write(content + '\n')
                    else:
                        content = ''.join(p_text.xpath('./strong/text()'))
                        file.write(content + '\n')

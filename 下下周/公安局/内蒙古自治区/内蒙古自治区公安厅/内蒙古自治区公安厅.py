...
base_url = 'http://gat.nmg.gov.cn/jwxz/qgyw/'
url_name = '内蒙古自治区公安厅'
notification_path = '全国警务要闻'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\公安局\\内蒙古自治区\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div/div[3]/div[3]/ul/li/a/@href'
tit_xpath = '/html/body/div/div[3]/div[3]/h3/text()'
menu_xpath = '//div[@class="g-crumbs"]//a//text()'
fb_time_xpath = '/html/body/div/div[3]/div[3]/div[1]/div[1]/text()'
ly_name_xpath = '/html/body/div/div[3]/div[3]/div[1]/div[1]/text()'
target_tag = 'div'
target_attr = {'class': 'g-con-wzzw wechatShare'}
...
for i in range(0, 3):
    if i == 0:
        url = 'http://gat.nmg.gov.cn/jwxz/qgyw/index.html'
    else:
        url = f'http://gat.nmg.gov.cn/jwxz/qgyw/index_{i}.html'

...
base_url = 'http://sfj.siping.gov.cn/fzxc/fljd/'
url_name = '四平市司法局'
notification_path = '法律解读'
...
tit_xpath = '/html/body/div[5]/div/div[4]/h6/text()'
menu_xpath = '//h2[@class="currentstation"]//a//text()'
fb_time_xpath = '/html/body/div[5]/div/div[1]/span[2]/text()'
ly_name_xpath = '/html/body/div[5]/div/div[1]/span[1]/text()'
target_tag = 'div'

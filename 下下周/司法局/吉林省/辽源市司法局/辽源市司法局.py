...
base_url = 'http://sfj.liaoyuan.gov.cn/gzdt/tsrq/'
url_name = '辽源市司法局'
notification_path = '特殊人群管理'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\司法局\\吉林省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div[3]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div/h2/text()'
menu_xpath = '//h2[@class="currentstation"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div/div[1]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[3]/div/div[1]/div[1]/span[2]/text()'
target_tag = 'div'

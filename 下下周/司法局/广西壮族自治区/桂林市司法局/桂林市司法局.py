...
base_url = 'https://sfj.guilin.gov.cn/xwzx/zwyw/'
url_name = '桂林市司法局'
notification_path = '政务要闻'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\司法局\\广西壮族自治区\\{url_name}'
...
target_tag = 'div'
target_attr = {'class': 'view TRS_UEDITOR trs_paper_default trs_word'}

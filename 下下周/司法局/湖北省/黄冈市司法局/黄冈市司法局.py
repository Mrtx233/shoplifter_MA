...
base_url = 'http://sfj.hg.gov.cn/xwzx/xsqdt/hzq/index.html'
url_name = '黄冈市司法局'
notification_path = '黄州区'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.15-7.19)\司法局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div/div[2]/div/div/div[2]/div[2]/div[3]/ul/li/a/@href'
...
for i in range(1, 21):
    if i == 1:
        ...
        url = f'http://sfj.hg.gov.cn/content/column/6797223?pageIndex={i}'
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'http://sfj.hg.gov.cn' + re.sub(r'\./', '/', page)
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//*[@id="wenzhang"]/div[2]//p'):

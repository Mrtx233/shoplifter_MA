...
page_list_xpath = '//*[@id="pc"]/div[4]/div/div[3]/div[1]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '//*[@id="pc"]/div[4]/div[4]/div/h2[1]/text()'
menu_xpath = '//div[@class="breakcrumb ma"]//a//text()'
fb_time_xpath = '//*[@id="pc"]/div[4]/div[4]/div/div[1]/text()'
ly_name_xpath = '//*[@id="pc"]/div[4]/div[4]/div/div[1]/text()'
...
for i in range(0, 16):
    if i == 0:
        url = 'https://mzj.nanning.gov.cn/mzdt/tzgg/index.html'
    else:
        url = f'https://mzj.nanning.gov.cn/mzdt/tzgg/index_{i}.html'
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'https://mzj.nanning.gov.cn/mzdt/tzgg' + re.sub(r'\./', '/', page)
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@id="UCAP-CONTENT"]//p'):

...
base_url = 'http://mzj.gxgg.gov.cn/zcwj/'
url_name = '贵港市民政局'
notification_path = '政策文件'
...
if tit_xpath == '':
    tit_xpath = '/html/body/div[2]/div[2]/div/h1/text()'
menu_xpath = '//div[@class="crumb-nav"]//a//text()'
fb_time_xpath = '/html/body/div[10]/div[2]/div/div[1]/div[1]/text()'

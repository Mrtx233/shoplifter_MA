...
base_url = 'http://www.fcgs.gov.cn/mzj/dtxx/'
url_name = '防城港市民政局'
notification_path = '动态信息'
...
tit_xpath = '/html/body/div[11]/div/div[2]/div/h1/text()'
menu_xpath = '//div[@class="crumb-nav"]//a//text()'
fb_time_xpath = '/html/body/div[11]/div/div[2]/div/div[1]/div[1]/text()'
ly_name_xpath = '/html/body/div[11]/div/div[2]/div/div[1]/div[1]/text()'
target_tag = 'div'

...
url_name = '咸阳市民政局'
notification_path = '民政动态'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\民政局\\陕西省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[5]/div[2]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '//*[@id="container"]/div[2]/div[1]/h3/text()'
menu_xpath = '//div[@class="position"]//a//text()'
fb_time_xpath = '//*[@id="container"]/div[2]/div[2]/div[1]/span/text()'
ly_name_xpath = '//*[@id="container"]/div[2]/div[2]/div[2]/span/text()'
...
for i in range(1, 26):
    if i == 1:
        url = 'http://xymz.xianyang.gov.cn/xwzx/mzzx_5491/index.html'
    else:
        url = f'http://xymz.xianyang.gov.cn/xwzx/mzzx_5491/index_{i}.html'
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'http://xymz.xianyang.gov.cn/xwzx/mzzx_5491' + re.sub(r'\./', '/', page)
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@class="mt10 mb10"]//p'):

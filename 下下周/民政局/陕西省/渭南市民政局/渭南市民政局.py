...
page_list_xpath = '/html/body/div[5]/div[2]/div[1]/div[2]/ul/li/a/@href'
...
for i in range(1, 3):
    url = f'https://mzj.weinan.gov.cn/minzyw/gzdt/{i}.html'
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'https://mzj.weinan.gov.cn' + re.sub(r'\./', '/', page)

...
base_url = 'http://mzj.xa.gov.cn/mzzx/tzgg/'
url_name = '西安市民政局'
notification_path = '综合快讯'
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.15-7.19)\\民政局\\陕西省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="lst-rt"]/article/a/@href'
tit_xpath = '//*[@id="printContent"]/h1/text()'
menu_xpath = '//div[@class="position"]//a//text()'
fb_time_xpath = '//*[@id="printContent"]/div[3]/span[1]/text()'
ly_name_xpath = '//*[@id="printContent"]/div[3]/span[2]/text()'
...
for i in range(11, 26):
    url = f'http://mzj.xa.gov.cn/mzzx/gnmz/list/{i}.html'
    # http://mzj.xa.gov.cn/mzzx/tzgg/list/12.html
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'http://mzj.xa.gov.cn' + re.sub(r'\./', '/', page)
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@id="article"]//p'):

...
page_list_xpath = '//div[@class="gl-list-con"]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div[2]/div/div[2]/h1/text()'
menu_xpath = '//div[@class="local"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div[2]/div/div[2]/div[1]/span[3]/text()'
ly_name_xpath = '/html/body/div[3]/div[2]/div/div[2]/div[1]/span[1]/text()'

for i in range(1, 9):
    url = f'https://gaj.zunyi.gov.cn/jwbd/index_{i}.html'
    ...
    for page in page_list:
        try:
            ...
            # page_url = page
            page_url = 'https://gaj.zunyi.gov.cn/jwbd' + re.sub(r'\./', '/', page)

...
base_url = 'https://gaj.trs.gov.cn/gaxw/ttxw/'
url_name = '铜川市公安局'
notification_path = '头条新闻'
...
page_list_xpath = '/html/body/div/div[2]/div/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '//*[@id="c"]/div[1]/div[1]/text()'
menu_xpath = '//div[@class="location"]//a//text()'
fb_time_xpath = '//*[@id="c"]/div[1]/div[2]/span[1]/text()'
ly_name_xpath = '//*[@id="c"]/div[1]/div[2]/span[2]/text()'

...
base_url = 'https://fssf.foshan.gov.cn/xwbd/mtbd/'
url_name = '佛山市司法局'
notification_path = '媒体报道'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\广东省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[2]/div/div[3]/ul/li/a/@href'
tit_xpath = '/html/body/div[2]/div/div[2]/h1/text()'
menu_xpath = '//div[@class="location"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div/div[2]/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[2]/div/div[2]/div[1]/span[2]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@id="context"]//p'):

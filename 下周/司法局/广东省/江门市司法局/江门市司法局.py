...
base_url = 'https://www.jiangmen.gov.cn/bmpd/jmssfj/zwgk/gzdt/'
url_name = '江门市司法局'
notification_path = '工作动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\广东省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[4]/div[2]/div[3]/div/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[4]/div/div[2]/h1/text()'
menu_xpath = '//div[@class="list_wz"]//a//text()'
fb_time_xpath = '/html/body/div[4]/div/div[2]/ul/li[1]/text()'
ly_name_xpath = '/html/body/div[4]/div/div[2]/ul/li[2]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@id="zoomcon"]//p'):

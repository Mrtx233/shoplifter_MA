...
base_url = 'https://www.zhanjiang.gov.cn/zjsfw/bmdh/sfj/zwgk/gzdt/'
url_name = '湛江市司法局'
notification_path = '工作动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\广东省\\{url_name}'
...
page_list_xpath = '/html/body/div[2]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[2]/div[2]/div/h3/text()'
menu_xpath = '//div[@class="pos"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[2]/div/div[1]/span[1]/text()'
ly_name_xpath = '/html/body/div[2]/div[2]/div/div[1]/span[2]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                page_url = page
                # page_url = 'http://www.tongchuan.gov.cn/' + re.sub(r'\./', '/', page)
                ...
                target_div = soup.find('div', class_='article')

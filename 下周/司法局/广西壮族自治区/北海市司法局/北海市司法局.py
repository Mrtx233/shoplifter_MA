...
base_url = 'http://www.bhpf.gov.cn/NewsList.asp?Page=1&pg=20&home='
url_name = '北海市司法局'
notification_path = '政府法治'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\广西壮族自治区\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div/div[1]/div/div[2]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div/div[1]/div/div[1]/div[2]/div[2]/div[1]/text()'
menu_xpath = '//div[@class="sub_path2"]//a//text()'
fb_time_xpath = '/html/body/div/div[1]/div/div[1]/div[2]/div[2]/div[2]/text()'
ly_name_xpath = '/html/body/div/div[1]/div/div[1]/div[2]/div[2]/div[2]/text()'
...
for i in range(0, 3):
    if i == 1:
        url = f'http://www.bhpf.gov.cn/NewsList.asp?Page=1&pg=20&home=1'
    else:
        url = f'{base_url}{i}'

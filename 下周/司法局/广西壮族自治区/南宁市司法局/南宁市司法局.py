...
base_url = 'https://sf.nanning.gov.cn/ywgz/zffzgz/zflf/'
page_list_xpath = '/html/body/div[3]/div/div[3]/div[1]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div[4]/div/h2[1]/text()'
menu_xpath = '//div[@class="breakcrumb ma"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div[4]/div/div[1]/text()'
ly_name_xpath = '/html/body/div[3]/div[4]/div/div[1]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', id='UCAP-CONTENT')

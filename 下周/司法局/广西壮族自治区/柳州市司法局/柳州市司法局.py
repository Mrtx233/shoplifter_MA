...
base_url = 'http://sfj.liuzhou.gov.cn/wsbs/ggfw/lsfw/'
page_list_xpath = '/html/body/div[2]/div/div/div[2]/div/div[2]/ul/li/div/div[1]/div/a/@href'
tit_xpath = '/html/body/div[2]/div/div/div[2]/div[1]/h3/text()'
menu_xpath = '//div[@class="breadcrumb-txt"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div/div/div[2]/div[1]/div/text()'
ly_name_xpath = '/html/body/div[2]/div/div/div[2]/div[1]/div/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='contentTextBox')

...
base_url = 'https://sfj.guilin.gov.cn/tzgg/'
page_list_xpath = '//*[@id="zlm_right"]/div[2]/ul/li/a/@href'
tit_xpath = '//*[@id="main"]/div[2]/div[2]/div[1]/p[1]/text()'
menu_xpath = '//*[@id="notice"]/ul//a//text()'
fb_time_xpath = '//*[@id="main"]/div[2]/div[2]/div[1]/p[2]/text()'
ly_name_xpath = '//*[@id="main"]/div[2]/div[2]/div[1]/p[2]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='view TRS_UEDITOR trs_paper_default trs_word')

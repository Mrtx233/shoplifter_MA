...
url_name = '平顶山市司法局'
notification_path = '以案释法'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\河南省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div[2]/h2/text()'
menu_xpath = '//div[@class="history"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div[2]/div[1]/text()'
ly_name_xpath = '/html/body/div[3]/div[2]/div[1]/text()'
...
for i in range(1, 15):
    if i == 1:
        url = 'https://sfj.pds.gov.cn/channels/33790.html'
    else:
        url = f'https://sfj.pds.gov.cn/channels/33790_{i}.html'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                # page_url = page
                page_url = 'https://sfj.pds.gov.cn/' + re.sub(r'\./', '', page)

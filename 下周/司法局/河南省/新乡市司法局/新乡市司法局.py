...
url_name = '新乡市司法局'
notification_path = '司法行政要闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\河南省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[5]/div/div[2]/div[2]/div/div/div[2]/dl/dd/div[1]/ul/li/a/@href'
...
# 循环抓取页面数据
for i in range(1, 15):
    url = f'https://sfj.xinxiang.gov.cn/index/list/34/{i}.html'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                # page_url = page
                page_url = 'https://sfj.xinxiang.gov.cn/' + re.sub(r'\./', '', page)

...
base_url = 'https://zzsfj.zhengzhou.gov.cn/fzyaowen/'
url_name = '郑州市司法局'
notification_path = '法治要闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\河南省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div/div[3]/div[2]/div/div/div[2]/dl/dd/div[3]/div/a/@href'
tit_xpath = '/html/body/div/div[3]/div[2]/div/div[2]/div[1]/text()'
menu_xpath = '//div[@class="location clearfix"]//a//text()'
fb_time_xpath = '/html/body/div/div[3]/div[2]/div/div[2]/div[3]/text()'
ly_name_xpath = '/html/body/div/div[3]/div[2]/div/div[2]/div[3]/text()'
...
for i in range(1, 31):
    if i == 1:
        url = 'https://zzsfj.zhengzhou.gov.cn/fzyaowen/index.jhtml'
    else:
        url = f'{base_url}index_{i}.jhtml'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='news_content_content')

...
base_url = 'https://sfj.xiaogan.gov.cn/zwdt/index.jhtml'
url_name = '孝感市司法局'
notification_path = '政务动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="bodyTab21"]/ul/li/a/@href'
tit_xpath = '//*[@id="js_article_content"]/div[1]/div[1]/text()'
menu_xpath = '/html/body/div[3]/ul//a//text()'
fb_time_xpath = '//*[@id="js_article_content"]/div[1]/div[3]/ul/li[1]/text()'
ly_name_xpath = '//*[@id="js_article_content"]/div[1]/div[3]/ul/li[2]/text()'
...
for i in range(301, 331):
    if i == 1:
        ...
        url = f'https://sfj.xiaogan.gov.cn/zwdt/index_{i}.jhtml'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', id="content_txt")

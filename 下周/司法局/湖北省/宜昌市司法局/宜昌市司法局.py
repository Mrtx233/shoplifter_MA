...
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="main"]/div/div/div[1]/div/div/div[2]/div/div[1]/a/@href'
tit_xpath = '//*[@id="main"]/div/div/div/div/div/div[2]/h1/text()'
menu_xpath = '//div[@class="txtlist-map"]//a//text()'
fb_time_xpath = '//*[@id="main"]/div/div/div/div/div/div[2]/div/div[1]/span[1]/text()'
ly_name_xpath = '//*[@id="main"]/div/div/div/div/div/div[2]/div/div[1]/span[2]/text()'
...
for i in range(1, 8):
    url =f'http://sfj.yichang.gov.cn/list-54126-{i}.html'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//*[@id="main"]/div/div/div/div/div/div[2]//p'):

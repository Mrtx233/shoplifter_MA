...
base_url = 'https://sfj.ezhou.gov.cn/xwzx_922/fywsgk/'
url_name = '鄂州市司法局'
notification_path = '行政复议'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="f_bg_in"]/div[2]/div[2]/div/div[2]/div/ul/li/a/@href'
tit_xpath = '//*[@id="f_bg_in"]/div[2]/div[2]/div/div/div[1]/h2/text()'
menu_xpath = '//div[@class="crumbs"]//a//text()'
fb_time_xpath = '//*[@id="f_bg_in"]/div[2]/div[2]/div/div/div[1]/div/span[2]/text()'
ly_name_xpath = '//*[@id="f_bg_in"]/div[2]/div[2]/div/div/div[1]/div/span[1]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='TRS_Editor')

# url_name = '恩施土家族苗族自治州民政局'
# notification_path = '公告通知'
...
base_url = 'http://sfj.huangshi.gov.cn/gzdt/ywdt/'
url_name = '黄石市司法局'
notification_path = '业务动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\司法局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[3]/div/div[2]/div/div/div/div[1]/ul/li/a/@href'
tit_xpath = '//*[@id="title"]/h1/text()'
menu_xpath = '//*[@id="crumb"]//a//text()'
fb_time_xpath = '//*[@id="title"]/p/text()'
ly_name_xpath = '//*[@id="title"]/p/text()'

...
base_url = 'https://jyj.gzlps.gov.cn/gzdt/jydt/'
page_list_xpath = '/html/body/div[3]/div[2]/div[1]/div[1]/ul/li/a/@href'
tit_xpath = '//*[@id="c"]/div[1]/text()'
menu_xpath = '//div[@class="bt-position"]//a//text()'

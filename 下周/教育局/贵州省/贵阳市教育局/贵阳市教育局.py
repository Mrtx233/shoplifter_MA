...
url_name = '贵阳市教育局'
notification_path = '图片新闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\教育局\贵州省\\{url_name}'
...
base_url = 'https://jyj.guiyang.gov.cn/newsite/xwzx/tpxw/'
page_list_xpath = '//*[@id="main"]/div/div[2]/div/ul/li/a/@href'
tit_xpath = '//*[@id="main"]/div/div[2]/div/div[1]/h1/text()'
menu_xpath = '//div[@class="breadcrumb"]//a//text()'
fb_time_xpath = '//*[@id="main"]/div/div[2]/div/div[1]/div/p[1]/span/text()'
ly_name_xpath = '//*[@id="main"]/div/div[2]/div/div[1]/div/p[2]/span/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='detail-cont')

...
base_url = 'https://jyj.trs.gov.cn/jyxw_500448/rdxw/'
url_name = '铜仁市教育局'
notification_path = '热点新闻'
...
page_list_xpath = '/html/body/div[4]/div[3]/div[2]/ul/li/div[1]/a/@href'
tit_xpath = '/html/body/div[12]/div[1]/div/div[2]/text()'
menu_xpath = '//div[@class="position"]//a//text()'
fb_time_xpath = '/html/body/div[12]/div[1]/div/div[3]/span[2]/text()'
ly_name_xpath = ""
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//font[@id="Zoom"]/div/p'):

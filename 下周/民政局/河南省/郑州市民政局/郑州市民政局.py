...
base_url = 'https://mzj.zhengzhou.gov.cn/gzdt/'
url_name = '郑州市民政局'
notification_path = '工作动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\河南省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div/div[2]/div[2]/div[1]/div[2]/div/a/@href'
tit_xpath = '/html/body/div/div[2]/div/div[2]/text()'
menu_xpath = '//div[@class="location"]//a//text()'
fb_time_xpath = '/html/body/div/div[2]/div/div[4]/text()'
ly_name_xpath = '/html/body/div/div[2]/div/div[4]/text()'
...
for i in range(11, 91):
    if i == 1:
        url = 'https://mzj.zhengzhou.gov.cn/gzdt/index.jhtml'
    else:

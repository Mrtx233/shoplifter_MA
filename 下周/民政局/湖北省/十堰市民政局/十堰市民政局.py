...
base_url = 'http://mzj.shiyan.gov.cn/gzdt_14726/'
url_name = '十堰市民政局'
notification_path = '工作动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="content"]/div[2]/ul/li/a/@href'
tit_xpath = '//*[@id="fonttitle"]/text()'
menu_xpath = '//*[@id="content"]/div/div[1]//a//text()'
fb_time_xpath = '//*[@id="titledate"]/text()'
ly_name_xpath = '//*[@id="titledate"]/text()'
...
for i in range(0, 11):
    if i == 0:
        url = 'http://mzj.shiyan.gov.cn/gzdt_14726/index.shtml'
    else:
        url = f'http://mzj.shiyan.gov.cn/gzdt_14726/index_{i}.shtml'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('font', id='fontzoom')

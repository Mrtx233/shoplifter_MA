...
base_url = 'http://mzj.xianning.gov.cn/xwzx/sxmz/'
url_name = '咸宁市民政局'
notification_path = '市县民政'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[4]/div[2]/div/div/ul/li/h2/a/@href'
tit_xpath = '/html/body/div[4]/div[2]/div/div/div[1]/h2/text()'
menu_xpath = '/html/body/div[4]/div[1]/div//a//text()'
fb_time_xpath = '/html/body/div[4]/div[2]/div/div/div[1]/p/span/em[1]/text()'
ly_name_xpath = '/html/body/div[4]/div[2]/div/div/div[1]/p/span/em[2]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='articleBox')

...
base_url = 'https://mzj.xiaogan.gov.cn/xsqxx/index.jhtml'
url_name = '孝感市民政局'
notification_path = '县市区信息'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="newslist"]/li/a/@href'
tit_xpath = '//*[@id="c"]/tbody/tr[1]/td/text()'
menu_xpath = '/html/body/div[1]/div[1]//a//text()'
fb_time_xpath = '//*[@id="c"]/tbody/tr[3]/td/table/tbody/tr/td/span[1]/text()'
ly_name_xpath = '//*[@id="c"]/tbody/tr[3]/td/table/tbody/tr/td/span[2]/text()'
...
for i in range(401, 451):
    if i == 1:
        ...
        url = f'https://mzj.xiaogan.gov.cn/xsqxx/index_{i}.jhtml'

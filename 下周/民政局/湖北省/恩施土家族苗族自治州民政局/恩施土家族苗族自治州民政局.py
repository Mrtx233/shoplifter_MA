...
base_url = 'http://mzj.enshi.gov.cn/ggtz/'
url_name = '恩施土家族苗族自治州民政局'
notification_path = '公告通知'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="list_article"]/ul/li/a/@href'
tit_xpath = '//*[@id="title"]/text()'
menu_xpath = '//div[@class="w70p fl p10 ofh"]//a//text()'
fb_time_xpath = '//*[@id="date"]/text()'
ly_name_xpath = '//*[@id="source"]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//div[@class_="view TRS_UEDITOR trs_paper_default trs_word"]//p'):

...
base_url = 'https://mzj.wuhan.gov.cn/mzdt_912/mzyw/'
url_name = '武汉市民政局'
notification_path = '民政要闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="share"]/li/a/@href'
tit_xpath = '//*[@id="Auxiliary"]/div[2]/div/div/div[1]/div[2]/h2/text()'
menu_xpath = '//div[@class="where mb20"]//a//text()'
fb_time_xpath = '//*[@id="Auxiliary"]/div[2]/div/div/div[1]/div[2]/div[1]/div[3]/span[1]/text()'
ly_name_xpath = '//*[@id="Auxiliary"]/div[8]/div/div/div[1]/div[2]/div[1]/div[3]/span[3]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='article-box')

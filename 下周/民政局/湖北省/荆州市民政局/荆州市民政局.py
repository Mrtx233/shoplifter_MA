...
base_url = 'http://mzj.jingzhou.gov.cn/xxdt/mzyw/'
url_name = '荆州市民政局'
notification_path = '民政要闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="container"]/div[3]/div[2]/div[1]/div[1]/ul/li/a/@href'
tit_xpath = '//*[@id="container"]/div[3]/div[2]/div[1]/em/text()'
menu_xpath = '//*[@id="container"]/div[3]/div[1]//a//text()'
fb_time_xpath = '//*[@id="container"]/div[3]/div[2]/div[2]/em/em[3]/text()'
ly_name_xpath = '//*[@id="container"]/div[3]/div[2]/div[2]/em/em[2]/text()'
...
for i in range(1, 11):
    if i == 0:
        ...
        url = f'http://mzj.jingzhou.gov.cn/xxdt/mzyw/index_{i}.shtml'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_="zw_cont_c")

...
base_url = 'https://mzj.suizhou.gov.cn/fbjd_10/ywdt/dtyw/'
url_name = '随州市民政局'
notification_path = '工作动态'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="Auxiliary"]/div[7]/div/div[2]/div[2]/div[1]/ul/li/a/@href'
tit_xpath = '//*[@id="Auxiliary"]/div[7]/div[2]/div/div[1]/h/text()'
menu_xpath = '//*[@id="Auxiliary"]/div[7]/div[1]/div/div//a//text()'
fb_time_xpath = '//*[@id="Auxiliary"]/div[7]/div[2]/div/div[1]/span[1]/text()'
ly_name_xpath = '//*[@id="Auxiliary"]/div[7]/div[2]/div/div[1]/span[2]/text()'
    ...
    try:
        ...
        for page in page_list:
            try:
                ...
                target_div = soup.find('div', class_='doc_content  news-detl-c')

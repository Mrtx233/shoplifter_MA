...
base_url = 'http://mzj.huangshi.gov.cn/xw/xsqxw/'
url_name = '黄石市民政局'
notification_path = '县市区新闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\民政局\湖北省\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '//*[@id="op1"]/ul/li/a/@href'
tit_xpath = '//*[@id="title"]/h1/text()'
menu_xpath = '//*[@id="crumb"]//a//text()'
fb_time_xpath = '//*[@id="title"]/p[1]/text()'
ly_name_xpath = '//*[@id="title"]/p[1]/text()'

...
page_list_xpath = '/html/body/div[4]/div[3]/ul/li/a/@href'
tit_xpath = '//*[@id="c1"]/div[1]/h1/text()'
menu_xpath = '//div[@class="current_wz"]//a//text()'
fb_time_xpath = '//*[@id="c1"]/div[2]/text()[2]'
ly_name_xpath = '//*[@id="c1"]/div[2]/text()[3]'

for i in range(1, 5):
    url = f'https://sthjj.anshun.gov.cn/zwgk/dqhj/index_{i}.html'

...
base_url = 'https://sthjj.trs.gov.cn/xwzx/sjdt/'
url_name = '铜仁市生态环境局'
notification_path = '市内要闻'
base_path = f'E:\WorkingWord\马缕_公文爬取(7.8-7.12)\生态环境局\贵州省\\{url_name}'
...
page_list_xpath = '/html/body/div[3]/div[2]/div/div[2]/div[2]/div[2]/ul/li/a/@href'
tit_xpath = '/html/body/div[9]/div[3]/div/div[2]/div[1]/text()'
menu_xpath = '//div[@class="Address Box"]//a//text()'
fb_time_xpath = '//*[@id="Art_date"]/text()'
ly_name_xpath = '//*[@id="Art_wzly"]/text()'
    ...
    for page in page_list:
        try:
            ...
            with open(file_path, 'a+', encoding='utf-8') as file:
                file.write(tit + '\n')
                for p_text in page_tree.xpath('//font[@id="Zoom"]//span'):

...
base_path = f'E:\WorkingWord\马缕_公文爬取(7.3-7.5)\生态环境局\贵州省\\{url_name}'
...
page_list_xpath = '//div[@class="main_rt_list"]/ul/li/a/@href'
tit_xpath = '//*[@id="c"]/div[1]/div[1]/h2/text()'
menu_xpath = '//div[@class="dqwz"]//a//text()'
fb_time_xpath = '//*[@id="c"]/div[1]/div[2]/text()[2]'
ly_name_xpath = '//*[@id="c"]/div[1]/div[2]/text()[3]'

for i in range(1, 11):
    url = f'https://sthj.gzlps.gov.cn/gzdt_43233/nszyw/index_{i}.html'
    # https://sthj.gzlps.gov.cn/gzdt_43233/tzgg_43236/

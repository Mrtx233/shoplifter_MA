...
base_path = f'E:\\WorkingWord\\马缕_公文爬取(7.3-7.5)\\{url_name}'
...
page_list_xpath = '//div[@class="lb"]/ul/li/a/@href'
tit_xpath = '/html/body/div[3]/div/div[1]/h1/text()'
menu_xpath = '//div[@class="current_wz"]//a//text()'
fb_time_xpath = '/html/body/div[3]/div/div[1]/div/p/text()[2]'
ly_name_xpath = '/html/body/div[3]/div/div[1]/div/text()[2]'

for i in range(60, 75):
    url = f'https://czj.gzlps.gov.cn/gzdt_42521/czdt/index_{i}.html'

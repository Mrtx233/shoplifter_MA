...
page_list_xpath = '/html/body/div[2]/div[2]/div[2]/div[2]/div[1]/ul/li/a/@href'
tit_xpath = '/html/body/div[2]/div[2]/h1[1]/text()'
menu_xpath = '//div[@class="path"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[2]/div[1]/div/span[1]/text()'
ly_name_xpath = '/html/body/div[2]/div[2]/div[1]/div/span[2]/text()'

for i in range(1, 11):
    url = f'https://zyepb.zunyi.gov.cn/xwzx/qxdt/index_{i}.html'

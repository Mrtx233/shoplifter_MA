...
base_url = 'https://www.cma.gov.cn/2011zwxx/2011zdflz/ywjj/'
url_name = '中国气象局'
notification_path = '要闻动态'
base_path = rf'E:\WorkingWord\马缕_新闻搞采集(8.5-8.9)\中央和国家机关、群团组织等政务发布平台\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

page_list_xpath = '/html/body/div[2]/div/a/@href'
tit_xpath = '/html/body/div[2]/div[2]/h3/text()'
menu_xpath = '//*[@id="ariaTipText"]//a//text()'
fb_time_xpath = '/html/body/div[2]/div[2]/div[1]/div[2]/span[1]/text()'
ly_name_xpath = '/html/body/div[2]/div[2]/div[1]/div[2]/span[2]/text()'
        ...
        for page in page_list:
            try:
                ...
                with open(file_path, 'a+', encoding='utf-8') as file:
                    file.write(tit + '\n')
                    for p_text in page_tree.xpath('//*[@id="con_content"]/div[1]//p'):

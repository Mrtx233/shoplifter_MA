...
url = 'http://www.zgjx.cn/news/index.htm?page=dfjx_2022'
target_xpath = '/html/body/div[4]/div[1]/div[2]/ul/li/a'
returned_final_links = extract_links(url, target_xpath)

url_name = '中国记协'
notification_path = '地方记协'
base_path = rf'E:\WorkingWord\马缕_新闻搞采集(8.5-8.9)\中央和国家机关、群团组织等政务发布平台\\{url_name}'
excel_file_name = f'{url_name}.xlsx'

tit_xpath = '/html/body/div[4]/div[2]/h1/text()'
menu_xpath = '/html/body/div[4]/div[1]//a//text()'
fb_time_xpath = '/html/body/div[4]/div[2]/div[1]/div[1]/text()'
ly_name_xpath = '/html/body/div[4]/div[2]/div[1]/div[1]/text()'
...
for page in returned_final_links:
    try:
        ...
        with open(file_path, 'a+', encoding='utf-8') as file:
            file.write(tit + '\n')
            for p_text in page_tree.xpath('//*[@id="Zoom"]//p'):
